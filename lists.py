'''
Contains lists of data used in gui_image_scaler.py.

Variables:
    dir_creation_list = A list of tuples.
    aspect_ratio_lists = A list of lists.
    image_size_list = A list of dicts.
'''

# Directory creation list.
dir_creation_list = [('4x5in.jpg', '4x5 Aspect Ratio'), ('4x6in.jpg', '2x3 Aspect Ratio'), ('5x7in.jpg', '5x7 Aspect Ratio'), ('6x8in.jpg', '3x4 Aspect Ratio'), ('11x14in.jpg', '11x14 Aspect Ratio'), ('A5P.jpg', 'ISO Sizes'),
